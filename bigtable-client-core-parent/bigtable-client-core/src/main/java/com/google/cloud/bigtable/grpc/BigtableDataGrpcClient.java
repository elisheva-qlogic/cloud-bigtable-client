...
public class BigtableDataGrpcClient implements BigtableDataClient, IBigtableDataClient {
  ...
  public BigtableDataGrpcClient(
    ...
    this.requestContext = RequestContext.create(
        InstanceName.of(bigtableOptions.getProjectId(), bigtableOptions.getInstanceId()),
        clientDefaultAppProfileId);
  ...
  @Override
  public ApiFuture<Void> mutateRowAsync(RowMutation rowMutation) throws InterruptedException {
