...
//    ConditionalRowMutation conditionalRowMutation = ConditionalRowMutation.create("fake-table", ByteString.copyFromUtf8("fake-rowKey"));
  ...
  public void testRowMutations() throws IOException {
    ...
    ConditionalRowMutation c = ConditionalRowMutation.create("fake-table", "fake-row");
